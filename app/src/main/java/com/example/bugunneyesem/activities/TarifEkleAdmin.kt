...
import com.example.bugunneyesem.databinding.ActivityTarifEkleAdminBinding
...
class TarifEkleAdmin : AppCompatActivity() {
    private lateinit var binding: ActivityTarifEkleAdminBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTarifEkleAdminBinding.inflate(layoutInflater)
