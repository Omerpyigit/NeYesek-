...
class TarifAdapterNePisirsem : RecyclerView.Adapter<TarifAdapterNePisirsem.HolderTarifFavorite> {
    private var context: Context

     var foodsArrayList: ArrayList<ModelTarif>
    ...
    private fun loadTarifDetails(model: ModelTarif, holder: TarifAdapterNePisirsem.HolderTarifFavorite, position: Int){
